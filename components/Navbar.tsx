...
// --- DESKTOP NAV LINK (WITH SQUARE HOVER) ---
  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-6xl">
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-full px-6 py-3 flex justify-between items-center shadow-2xl relative">
        ...
        {/* Desktop Links - 18px and Smooth Hover */}
        ...
        <div className="hidden md:block">
          <motion.a
            ...
            whileTap={{ scale: 0.96 }}
            className="bg-[#2563EB] text-white px-8 py-2.5 rounded-full text-[13px] font-bold uppercase tracking-widest cursor-pointer shadow-lg hover:bg-blue-700 transition-all"
          >
            Contact
          </motion.a>
        </div>
        ...
        <button 
          className="md:hidden p-2 text-slate-800 cursor-pointer outline-none"
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              <a 
                href="mailto:sean@bluedovemarketing.com"
                className="w-full text-center bg-blue-600 text-white py-5 rounded-2xl font-bold uppercase tracking-widest text-sm"
              >
                Contact Us
              </a>
            </motion.div>
