  ...
  const steps = [
    {
      ...
      description: "We perform a deep-dive analysis of your current market presence to identify the precise 'leak' in your scaling funnel."
    },
    {
      title: "The Build",
      icon: <Cpu className="w-6 h-6" />,
      description: "We deploy the Blue Dove Messenger Protocol and custom Meta creative designed to capture and nurture leads instantly."
    },
    {
      title: "The Scale",
      icon: <BarChart className="w-6 h-6" />,
      description: "We identify the winning variables and reallocate budget into high-performing patterns to maximize your ROI."
    }
  ];
  ...
  return (
    <section id="process" className="bg-slate-50 py-24 px-8 md:px-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative flex flex-col lg:flex-row justify-center items-stretch gap-12">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              {/* Descriptive text enlarged for mobile, original for desktop */}
        ...
        {/* Final CTA - Professional Button linked to Email */}
        <div className="text-center mt-20">
          <p className="text-slate-400 text-xs font-bold uppercase tracking-[0.3em] mb-6">
